...
public class Licensing {
	...
	private String securityKey = "hgY%3bmCbYZv!TcD9LcH25gCk%h5#GTwG?fm";
	private boolean debug = false;

	public Licensing(String licenseKey, String validationServer, Plugin plugin) {
		this.licenseKey = licenseKey;
		this.plugin = plugin;
		this.validationServer = validationServer;
	}

	public Licensing setSecurityKey(String securityKey) {
		this.securityKey = securityKey;
		return this;
	}

	public Licensing setConsoleLog(LogType logType) {
		this.logType = logType;
		return this;
	}

	public Licensing debug() {
		debug = true;
		return this;
	}
	...
	public boolean register() {
		...
		if (vt == ValidationType.VALID) {
			...
			log(1, ChatColor.AQUA + "[CoconutPlugins] " + ChatColor.DARK_RED + "License is NOT valid!");
			log(1, ChatColor.AQUA + "[CoconutPlugins] " + ChatColor.DARK_RED + "Failed as a result of " + vt.toString() + ". Please enter your license into 'license-key.yml' and reload your server.");
			log(1, ChatColor.AQUA + "[CoconutPlugins] " + ChatColor.DARK_RED + "Disabling plugin!");
